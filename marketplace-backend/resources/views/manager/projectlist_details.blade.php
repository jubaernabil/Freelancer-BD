    ...
    <div class="main-body">
          ...
          <nav aria-label="breadcrumb" class="main-breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="/list/{{$project->id}}">User</a></li>
            ...
            <div class="col-md-8">
              ...
              <div class="card" style="width: 18rem;" class="col-md-4" >
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text"><h5>Time:</h5><span>{{$project['time']}}</span></p>
              ...
              @if($project->active =='1')
              <a class="btn btn-warning "   target="__blank" href="/suspend/project/{{$project->id}}">Suspend</a>
              @else
              <a class="btn btn-primary "  target="__blank" href="/active/project/{{$project->id}}">Active</a>
              @endif
                    </div>
                  </div>
