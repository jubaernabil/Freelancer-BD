...
<div class="main-body">
      ...
      <nav aria-label="breadcrumb" class="main-breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a class=" btn btn-primary" style="text-decoration: none; color: white;" href="/buyer">Home</a></li>
        </ol>
      </nav>
      <!-- /Breadcrumb -->
        ...
        <div class="col mb-3">
          <div class="card">
            <div class="card-body text-center">
              <img src="{{('/protfolio_img/'.$bid->image)}}" style="width:100px;margin-top:-65px" alt="User" class="img-fluid img-thumbnail rounded-circle border-0 mb-3">
              <h5 class="card-title">{{$bid->username}}</h5>
              <p class="text-secondary mb-1">{{$bid->description}}</p>
            </div>
            <div class="card-footer">
              ...
              <button class="btn btn-light btn-sm bg-white has-icon ml-2" type="button"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-message-circle"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg></button>
               <a style="text-decoration: none;" href="/seller_bidingprojecDelete/{{$bid->id}}">Details</a><hr>
                <a style="text-decoration: none;" class="btn btn-primary" href="/bid/approve/{{$bid->id}}">Aprove</a>
            </div>
          </div>
